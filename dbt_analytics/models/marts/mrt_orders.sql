WITH CTE AS (
	SELECT
		...
		,PROV_BASE_PLACE.NET_BASE_PROVISION
		,PROV_BASE_PLACE.GROSS_PLACEMENT_PROVISION
		,PROV_BASE_PLACE.NET_PLACEMENT_PROVISION
		,PROV_PROP.GROSS_PROPORTIONAL_PROVISION
		,PROV_PROP.NET_PROPORTIONAL_PROVISION
	FROM
