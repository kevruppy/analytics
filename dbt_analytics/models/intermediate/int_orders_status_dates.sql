...
,CTE_ORDERS_STATUS_DATES AS (
	SELECT
		...
		,CASE WHEN FORWARDING_DATE IS NOT NULL THEN TRUE ELSE FALSE END AS IS_FORWARDED -- noqa: ST02
		,CASE WHEN CANCELLATION_DATE IS NOT NULL THEN TRUE ELSE FALSE END AS IS_CANCELLED -- noqa: ST02
		,CASE WHEN CONFIRMATION_DATE IS NOT NULL THEN TRUE ELSE FALSE END AS IS_CONFIRMED -- noqa: ST02
	FROM
		CTE_ORDERS
)
