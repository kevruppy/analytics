...
,CTE_GROSS_ORDERS_PROP_PROV AS (
	SELECT
		...
		,CTE_GROSS_ORDERS.CREATION_DATE
		,CTE_GROSS_ORDERS.PRODUCT_NAME
...
,CTE_NET_ORDERS_PROP_PROV AS (
	SELECT
		...
		,CTE_NET_ORDERS.CREATION_DATE
		,CTE_NET_ORDERS.PRODUCT_NAME
...
,CTE_GROSS_NET_ORDERS_PROP_PROV AS (
	SELECT
		...
		,CTE_GROSS_ORDERS_PROP_PROV.CREATION_DATE
		,CTE_GROSS_ORDERS_PROP_PROV.PRODUCT_NAME
